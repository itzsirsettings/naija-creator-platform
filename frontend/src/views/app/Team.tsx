          ...
          {members.map((m) => (
            <div key={m.id} className="flex items-center justify-between gap-3 rounded-xl border border-border bg-card p-3 shadow-sm">
              <div className="flex items-center gap-3 min-w-0">
                <div className="flex size-9 shrink-0 items-center justify-center rounded-lg bg-[#0A0A9F]/10 text-[11px] font-bold text-[#0A0A9F]">
                  {initials(m.name)}
                </div>
  ...
  return (
    <div>
      <h1 className="flex items-center gap-2 font-heading text-2xl font-bold tracking-tight">
        <Users className="size-6 text-[#0A0A9F]" /> Team
      </h1>
