  ...
  return (
    <Section className="overflow-hidden text-center">
      ...
      >
        ...
        <Link
          to="/for-creators"
          className="mt-7 inline-flex items-center gap-2.5 font-runde text-[14.6px] font-medium text-[#0f0f0f] transition-colors hover:text-[#0A0A9F]"
        >
          <span className="flex size-7 items-center justify-center rounded-full bg-gradient-to-br from-[#22d3ee] via-[#5d9c06] to-[#0A0A9F]">
      ...
      >
        ...
        >
          ...
          <path d="M160,122 C160,215 95,235 95,328" stroke="#0A0A9F" strokeWidth="2.5" strokeLinecap="round" strokeDasharray="1 8" />
          {/* Creator -> right card (purple) */}
          <path d="M840,122 C840,215 905,235 905,328" stroke="#0A0A9F" strokeWidth="2.5" strokeLinecap="round" strokeDasharray="1 8" />
...
function VConnector() {
  return (
    <div
      ...
      style={{
        backgroundImage: "linear-gradient(to bottom, #0A0A9F 0 40%, transparent 40%)",
