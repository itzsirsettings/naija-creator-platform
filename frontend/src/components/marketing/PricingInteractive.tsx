...
/**
 * PricingInteractive — client component that handles:
 * - Monthly/annual billing toggle
 * - Auth-aware CTA link routing
 * - FAQ accordion animation
 *
 * Kept as a client island so the static price table, comparison table,
 * and page structure are server-rendered and crawlable.
 */
...
export default function PricingInteractive() {
  ...
  return (
    <>
      ...
      {/* HEADER — badge + h1 + stats are static and in the server wrapper; only toggle is interactive */}
                ...
                style={
                  plan.featured
                    ? {
                        ...
                        boxShadow: "0 0 20px rgba(139,92,246,0.5), 0 0 40px rgba(139,92,246,0.4), 0 0 80px rgba(139,92,246,0.3)",
                      }
                    : undefined
                }
              >
